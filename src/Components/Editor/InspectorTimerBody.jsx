...
import {
  ColourRow, DraftInput, InspectorSection, LayoutFields, ResetStyle, SelectField, ToggleRow,
...
export default function InspectorTimerBody({ element, pageId, busy }) {
  ...
  return (
    <>
      {/* Countdown is the only mode that ships, so there is no mode field until
          a second mode exists: a disabled one-option select only adds noise. */}
