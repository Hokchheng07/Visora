...
export default function ProfileHero({
  ...
  return(
    <section className="relative overflow-hidden rounded-t-[20px] border border-b-0 border-[var(--border-card)] bg-[var(--surface-card)] sm:rounded-t-[24px] lg:rounded-t-[30px]">
      {/* TOP COLOR */}
      ...
      <div className="relative grid gap-7 px-4 py-7 sm:px-6 sm:py-8 md:grid-cols-[190px_minmax(0,1fr)] md:items-center md:gap-8 lg:grid-cols-[210px_minmax(0,1fr)_240px] lg:px-8 xl:grid-cols-[240px_minmax(0,1fr)_280px] xl:gap-10 xl:px-10 xl:py-10">
        {/* PHOTO */}
        <div className="relative mx-auto w-[180px] rotate-[-2deg] sm:w-[205px] md:mx-0 md:w-[190px] lg:w-[210px] xl:w-[240px]">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="mt-3 inline-flex rounded-full bg-accent/20 px-3 py-1.5 text-[11px] font-semibold text-primary sm:mt-4 sm:px-4 sm:py-2 sm:text-sm">
            {profile.role}
          </div>

          <p className="mx-auto mt-4 max-w-3xl text-sm leading-6 text-[var(--text-body)] sm:mt-5 sm:leading-7 md:mx-0 lg:text-base">
            {profile.bio}
          </p>

          <div className="mt-4 flex flex-col items-center gap-2 text-xs text-[var(--text-muted)] sm:flex-row sm:flex-wrap sm:justify-center sm:gap-5 sm:text-sm md:justify-start">
        ...
        {/* CREATIVE FOCUS */}
        <div className="relative mx-auto w-full max-w-[320px] md:col-span-2 md:max-w-none lg:col-span-1 lg:mx-0 lg:max-w-[270px]">
