...
export default function TemplateHeader({
  ...
  return(
    <div className="templates-header mx-auto w-full max-w-7xl px-4 text-center sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16">
      <div className="templates-header-accents" aria-hidden="true">
      ...
      <h1 className="mx-auto max-w-[900px] text-[32px] font-bold leading-[1.15] text-[var(--text-heading)] sm:text-[38px] md:text-[42px] lg:max-w-none lg:whitespace-nowrap lg:text-[46px] xl:text-[50px] 2xl:text-[64px]">
        ...
        <span className="relative inline-block text-primary">
          ...
          <img
            src={yellowLine}
            alt=""
            className="templates-title-underline pointer-events-none absolute -bottom-3 left-1/2 w-[90%] -translate-x-1/2 select-none sm:-bottom-4 sm:w-[92%] md:w-[94%] lg:w-[95%] xl:-bottom-5 2xl:-bottom-6 2xl:w-[105%]"
          />
        </span>
      </h1>
      ...
      <div className="mx-auto mt-8 flex w-full max-w-[520px] flex-col gap-3 sm:mt-9 sm:max-w-[600px] md:mt-10 md:max-w-[760px] md:flex-row md:gap-3 lg:max-w-[850px] xl:max-w-[950px] 2xl:mt-14 2xl:max-w-[1200px] 2xl:gap-4">
        <div className="templates-search-field relative min-w-0 flex-1">
          <Search
            size={18}
          ...
          >
            ...
            {activeFilterCount > 0 && <span className="templates-search-filter-count">{activeFilterCount}</span>}
          </button>
        </div>
