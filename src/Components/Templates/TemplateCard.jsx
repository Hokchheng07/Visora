  ...
  return (
    ...
    >
      <div className="relative z-10 overflow-hidden rounded-[22px]">
        ...
        <div className="flex items-start gap-3 px-5 pt-3 text-[28px] font-normal leading-tight text-[#111] text-left">
        ...
        <div className="flex flex-wrap items-center gap-1.5 px-5 pb-4 pt-3 text-[12px] text-[#666]">
