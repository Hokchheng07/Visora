...
const Footer = () => (
  <footer className="relative shrink-0 overflow-hidden bg-white font-sans text-[#252525]">
    ...
    <div className="relative z-10 mx-auto max-w-[1500px] px-5 pt-12 pb-2 sm:px-8 lg:px-12 xl:px-14">
      ...
      {/* 1280px+ */}
      <div className="hidden xl:grid xl:grid-cols-[1.3fr_.85fr_.85fr_.85fr_1.45fr] xl:items-start xl:gap-10">
        <Brand />
      ...
      {/* Bottom */}
      <div className="flex flex-col items-center justify-between gap-6 py-4 lg:flex-row pb-0">
